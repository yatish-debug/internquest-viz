  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // InternQuest Professional Variants
        hero: "hero-gradient text-primary-foreground hover:shadow-glow font-semibold transition-bounce hover:scale-105",
        ...
        professional: "bg-card border border-border text-card-foreground hover:bg-muted shadow-soft hover:shadow-medium hover-lift",
        gradient: "hero-gradient text-primary-foreground shadow-medium hover:shadow-glow hover:scale-105 transition-bounce font-medium",
      },
      size: {
